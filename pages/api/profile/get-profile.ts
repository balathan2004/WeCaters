...
export default async function (
  ...
  try {
    if (uid) {
      ...
      let finalUser: profileUserInterface = {
        ...specifiedUser,
        ...userMetaDoc.userConnections,
        reviews: userMetaDoc.reviews
      ...
      const userPosts = specificPost.docs.map((doc) => {
        return doc.data() as postInterface;
      });
